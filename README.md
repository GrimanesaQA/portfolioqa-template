...
🔗 [Ver Web Portfolio QA](https://grimanesaqa.github.io/portfolioqa-template/)
...
- Proyecto Supabase (requiere acceso): [Supabase Project](https://supabase.com/dashboard/project/ftcodlfejxohhvbtrjds)  

## 🗄 API de Formulario
Se ha generado una API que permite agregar, editar, consultar y eliminar datos de la base de datos creada en supabase.
- URL API (requiere acceso): [Supabase API](https://ftcodlfejxohhvbtrjds.supabase.co/rest/v1/form)  
- Documentación de la API: [Documentación API](https://grimanesaqa.github.io/portfolioqa-template/apidoc.html) 
---
...
### Pruebas de API
- Colección en POSTMAN (requiere acceso): [POSTMAN Collection](https://grimanesaqa-8525787.postman.co/workspace/c3bc6233-7477-4fd8-8245-fc19eaecc152/collection/53334927-f84f5978-26a7-4386-a231-863c375d7b27?action=share&source=copy-link&creator=53334927) 
...
## 👩‍💻 Autora
**Grimanesa Lozano – QA Junior**  
[🔗 LinkedIn](https://www.linkedin.com/in/grimanesa-l-a2a8aa11b/)
